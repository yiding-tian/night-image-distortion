...
def apply_camera_shake(folder_path, output_folder, level_name, dataset_results, dataset_lock, visual_analysis, cmp_mode=False):
    """
    ...
    try:
        ...
        answer_text = ANSWER_TEMPLATE.format(
            ...
            scope="Global",
            type="Camera Shake",
            target_info="affects the entire frame uniformly due to handheld instability",
